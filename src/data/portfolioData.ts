...
export const PROJECTS: Project[] = [
  {
    ...
    description: 'A premium bilingual website for a Dubai law firm, designed to establish authority, showcase legal expertise, and turn website visitors into consultation enquiries.',
    highlights: [
      'Premium authority-focused design',
      'Structured practice-area & content pages',
      'Consultation-focused conversion flow',
      'Full English + Arabic RTL experience',
    ],
  ...
  },
  {
    ...
    title: 'Healing Harmony — Clinic Management System',
    description: 'A full-stack clinic platform that combines a multilingual patient website with role-based tools for doctors, receptionists, and administrators.',
    highlights: [
      'Online appointment & walk-in management',
      'Doctor, receptionist & admin dashboards',
      'Patient records, queue & prescription management',
      'English, Hindi, Gujarati & Marathi support',
    ],
    ctaText: 'Want something like this?',
    visualType: 'clinic',
